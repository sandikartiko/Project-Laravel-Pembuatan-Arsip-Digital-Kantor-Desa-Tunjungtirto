...
<body>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a class="nav-link scrollto active" href="#hero"><span>DAFTAR ARSIP</span> <i
            ...
            <ul>
              <li><a class="nav-link scrollto active" href="tampildata">Surat Masuk</a></li>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container" style="height: 38vh;">
          <h2 class="animate__animated animate__fadeInDown" style="font-size: 35px;">Daftar Surat Masuk </h2>
  ...
  <section id="services" class="services">
    <div class="container" >
      <section class="content card" style="padding: 10px 10px 10px 10px; border-radius:30px ">
        <div class="row">
          <div class="col">
            <center>
            <h1><i class="nav-icon fas fa-envelope my-1 btn-sm-1"></i> Surat Masuk</h1>
            </center>
          </div>
        </div>
        <br>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form class="form-inline">
                  ...
                  <a href="tampildata.php" class="btn btn-danger">Reset</a>
                </form>
              </div>
            </div>
          </div>
        ...
        <br>
        <div class="col">
          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ubahModal" ><i class="bi bi-person-plus-fill"> Tambah Data</i></button> ||
          <a href="../CETAK DATA/cetaksuratmasuk.php" class=" btn btn-success" target="_blank"><i class="bi bi-printer-fill"> PRINT </a></i>
        </div>
        ...
        <div class="table-responsive">
          <div class="col">
            <table class="table table-dark table-bordered">
              ...
              <?php 
                 $SqlQuery= mysqli_query($kon, "SELECT * FROM suratmasuk ORDER BY tanggal ");
                 ...
                 if($kolomCari=="" && $kolomKataKunci==""){
                   $SqlQuery = mysqli_query($kon, "SELECT * FROM suratmasuk ORDER BY tanggal LIMIT ".$limitStart.",".$limit);
                 }else{
                   //kondisi jika parameter kolom pencarian diisi
                   $SqlQuery = mysqli_query($kon, "SELECT * FROM suratmasuk  WHERE $kolomCari LIKE '%$kolomKataKunci%' LIMIT ".$limitStart.",".$limit);
                 }
                 $no = $limitStart + 1;
              ...
              <tr>
                ...
                <td><?php echo $data['File_Document'] ?></td>
                <td><a href="../TAMPIL PDF/tampilpdf.php?id=<?=$data['id']?>"><i class="bi bi-file-pdf-fill"></i>  lihat berkas</a>
                </td>
                </a>
                </td> 
                <td>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form method="POST" action="../CRUD/aksi_crud.php" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?= $data['id']?>">
                        <div class="form-group">
                          <label class="control-label">No Berkas</label>
                          <input type="text" name="tberkas" value="<?=$data['No_Berkas']?>" class="form-control"
                            required ><br>
                        </div>
                        <div class="form-group">
                          <label class="control-label">Alamat Pengirim</label>
                          <input type="text" name="talamat" value="<?=$data['Alamat_Pengirim']?>" class="form-control"
                            required ><br>
                        </div>
                        <div class="form-group">
                          <label class="control-label">Tanggal</label>
                          <input type="date" name="ttanggal" value="<?=$data['Tanggal']?>" class="form-control" required
                            ><br>
                        </div>
                        <div class="form-group">
                          <label class="control-label">Keterangan</label>
                          <input type="text" name="tketerangan" value="<?=$data['Keterangan']?>" class="form-control"
                            required ><br>
                        </div>
                        <div class="form-group">
                          <label class="control-label">Upload file</label>
                          <input  type="file" name="tfile" value="<?=$data['File_Document']?>" class="form-control"
                           ><br>
                        </div>
              ...
              <div class="modal fade" id="modalHapus<?= $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form method="POST" action="../CRUD/aksi_crud.php">
                        <input type="hidden" name="id" value="<?= $data['id']?>">
            ...
            <nav aria-label="Page navigation example">
              <ul class="pagination justify-content-center">
                <li class="page-item disabled">
                   ...
                   ?>
                    ...
                    <?php
                           ...
                           if($kolomCari=="" && $kolomKataKunci==""){
                     ?>
                          <li class="page-item"><a class="page-link" href="tampildata.php?page=<?php echo $LinkPrev; ?>">Previous</a></li>

                    <?php     
                     }else{
                    ?>
                          <li><a href="tampildata.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $LinkPrev;?>">Previous</a></li>
                    <?php
                     } 
                   }
                   ?>
                   <?php
                    //kondisi jika parameter pencarian kosong
                    if($kolomCari=="" && $kolomKataKunci==""){
                    $SqlQuery = mysqli_query($kon, "SELECT * FROM suratmasuk");
                    }else{
                          //kondisi jika parameter kolom pencarian diisi
                           $SqlQuery = mysqli_query($kon, "SELECT * FROM suratmasuk WHERE $kolomCari LIKE '%$kolomKataKunci%'");
                    }     
                    ...
                    if($kolomCari=="" && $kolomKataKunci==""){
                    ?>
                        <li class="page-item" <?php echo $linkActive; ?>><a class="page-link"href="tampildata.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                   <?php
                    }else{
                    ?>
                <li class="page-item" <?php echo $linkActive; ?>><a class="page-link"
                    href="tampildata.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
                <?php
                  }
               }
                ...
                if($kolomCari=="" && $kolomKataKunci==""){
                ?>
                    <li class="page-item"><a class="page-link" href="tampildata.php?page=<?php echo $linkNext; ?>">Next</a>
                </li>
                <?php     
                 }else{
                 ?>
                  <li class="page-item"><a class="page-link"
                    href="tampildata.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $linkNext; ?>">Next</a>
                  </li>
                <?php
                  }
                }
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="POST" action="../CRUD/aksi_crud.php" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label class="control-label">No Berkas</label>
                        <input type="text" name="tberkas" class="form-control" required >
                      </div><br>
                      <div class="form-group">
                        <label class="control-label">Alamat Pengirim</label>
                        <input type="text" name="talamat" class="form-control" required >
                      </div><br>
                      <div class="form-group">
                        <label class="control-label">Tanggal</label>
                      ...
                      <div class="form-group">
                        <label class="control-label" >Upload file</label>
                        <input type="file" name="tfile[]" class="form-control" multiple>
                      </div><br>
