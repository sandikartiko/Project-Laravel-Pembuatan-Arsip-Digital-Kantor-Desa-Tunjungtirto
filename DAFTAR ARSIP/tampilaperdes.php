        ...
        <ul>
          ...
          <li class="dropdown"><a class="nav-link scrollto active" href="#hero"><span>DAFTAR ARSIP</span> <i
            ...
            <ul>
              ...
              <li><a class="nav-link scrollto active" href="#hero"><span>Peraturan Desa</span> <i></i></a>
              <li><a href="tampilkades.php">Peraturan Kades</a></li>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container" style="height: 38vh;">
          <h2 class="animate__animated animate__fadeInDown" style="font-size: 35px;">Daftar Peraturan Desa</h2>
  ...
  <section id="services" class="services">
    <div class="container">
      ...
      <div class="row">
          <div class="col">
            <center>
            <h1><i class="nav-icon fas fa-envelope my-1 btn-sm-1"></i> Peraturan Desa</h1>
            </center>
          </div>
        </div>
        <br>
                ...
                <form class="form-inline">
                  <div class="form-group">
                    <select class="form-control" id="Kolom" name="Kolom" required="">
                      ...
                      <option value="TangalSepakat" <?php if ($kolom=="TangalSepakat") echo "selected";?>>Tanggal</option>
                    </select>
                    <br>
                  </div>
                  ...
                  <a href="tampilaperdes.php" class="btn btn-danger">Reset</a>
                </form>
              </div>
            </div>
          </div>
        ...
        <div class="col">
          ...
          ||
            <a href="../CETAK DATA/cetakperdes.php" class="btn btn-success" target="_blank"><i class="bi bi-printer-fill"> PRINT </a></i>
        </div>
        <br>
        <div class="row table-responsive">
          <div class="col">
            <table class="table table-dark table-striped">
              ...
              <?php 
                 $SqlQuery= mysqli_query($kon, "SELECT * FROM perdes ORDER BY TangalSepakat ");
                 ...
                 if($kolomCari=="" && $kolomKataKunci==""){
                   $SqlQuery = mysqli_query($kon, "SELECT * FROM perdes ORDER BY TangalSepakat LIMIT ".$limitStart.",".$limit);
                 }else{
                   //kondisi jika parameter kolom pencarian diisi
                   $SqlQuery = mysqli_query($kon, "SELECT * FROM perdes  WHERE $kolomCari LIKE '%$kolomKataKunci%' LIMIT ".$limitStart.",".$limit);
                 }
                 $no = $limitStart + 1;
              ...
              <tr>
                <td><?php echo $no++?></td>
                <td><?php echo $data['JenisPerdes'] ?></td>
                <td><?php echo $data['NoTanggalDt'] ?></td>
                <td><?php echo $data['Tentang'] ?></td>
                <td><?php echo $data['Uraian'] ?></td>
                <td><?php echo $data['TangalSepakat'] ?></td>
                <td><?php echo $data['NoTanggalDl'] ?></td>
                <td><?php echo $data['NoTanggalLD'] ?></td>
                <td><?php echo $data['NoTanggalBD'] ?></td>
                <td><?php echo $data['Keterangan'] ?></td>
                <td><a href="../TAMPIL PDF/tampilpdfperdes.php?id=<?=$data['id']?>"><?php echo $data['File_Document']?></a>
                  </td>
                </td>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form method="POST" action="../CRUD/aksi_crud_perdes.php" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?= $data['id']?>">
                        <div class="form-group">
                          <label class="control-label">Jenis Perdes</label>
                          <input type="text" name="apjp" value="<?=$data['JenisPerdes']?>" class="form-control"
                            required>
                        </div>
                        <div>
                        <label class="control-label">No dan Tanggal Ditetapkan</label>
                          <input type="text" name="apntd" value="<?=$data['NoTanggalDt']?>" class="form-control"
                            required>
                        </div>
                        <div>
                        <label class="control-label">Tentang</label>
                          <input type="text" name="apt" value="<?=$data['Tentang']?>" class="form-control"
                            required>
                        </div>
                        <div>
                        <label class="control-label">Uraian</label>
                          <input type="text" name="apu" value="<?=$data['Uraian']?>" class="form-control"
                            required>
                        </div>
                        <div class="form-group">
                        <label class="control-label">Tanggal Sepakat</label>
                          <input type="date" name="aptkp" value="<?=$data['TangalSepakat']?>" class="form-control"
                            required>
                        </div>
                        <div>
                        <label class="control-label">No dan Tanggal Dilaporkan</label>
                          <input type="text" name="apntdl" value="<?=$data['NoTanggalDl']?>" class="form-control"
                            required>
                        </div>
                        <div>
                        <label class="control-label">No dan Tanggal Diundangkan Lembaran Desa</label>
                          <input type="text" name="apntdld" value="<?=$data['NoTanggalLD']?>" class="form-control"
                            required>
                        </div>
                        <div>
                        <label class="control-label">No dan Tanggal Diundangkan Berita Desa</label>
                          <input type="text" name="apntdbd" value="<?=$data['NoTanggalBD']?>" class="form-control"
                            required>
                        </div>
                        <div>
                        <label class="control-label">Keterangan</label>
                          <input type="text" name="apk" value="<?=$data['Keterangan']?>" class="form-control"
                            required>
                        </div>
                        <div class="form-group">
              ...
              <div class="modal fade" id="modalHapus<?= $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form method="POST" action="../CRUD/aksi_crud_perdes.php">
                        <input type="hidden" name="id" value="<?= $data['id']?>">

                          <h5 class="text-center"> Apakah Anda Yakin Akan Menghapus Data Ini ? <br>
                            <span class="text-danger"><?=$data['JenisPerdes']?></span>
                            </span>
                        </h5>
                        <div class="modal-footer">
            ...
            <nav aria-label="Page navigation example">
              <ul class="pagination justify-content-center">
                <li class="page-item disabled">
                   ...
                   ?>
                    ...
                    <?php
                           ...
                           if($kolomCari=="" && $kolomKataKunci==""){
                     ?>
                          <li class="page-item"><a class="page-link" href="tampilaperdes.php?page=<?php echo $LinkPrev; ?>">Previous</a></li>

                    <?php     
                     }else{
                    ?>
                          <li><a href="tampilaperdes.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $LinkPrev;?>">Previous</a></li>
                    <?php
                     } 
                   }
                   ?>
                   <?php
                    //kondisi jika parameter pencarian kosong
                    if($kolomCari=="" && $kolomKataKunci==""){
                    $SqlQuery = mysqli_query($kon, "SELECT * FROM perdes");
                    }else{
                          //kondisi jika parameter kolom pencarian diisi
                           $SqlQuery = mysqli_query($kon, "SELECT * FROM perdes WHERE $kolomCari LIKE '%$kolomKataKunci%'");
                    }     
                    ...
                    if($kolomCari=="" && $kolomKataKunci==""){
                    ?>
                        <li class="page-item" <?php echo $linkActive; ?>><a class="page-link"href="tampilaperdes.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                   <?php
                    }else{
                    ?>
                <li class="page-item" <?php echo $linkActive; ?>><a class="page-link"
                    href="tampilaperdes.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
                <?php
                  }
               }
                ...
                if($kolomCari=="" && $kolomKataKunci==""){
                ?>
                    <li class="page-item"><a class="page-link" href="tampilaperdes.php?page=<?php echo $linkNext; ?>">Next</a>
                </li>
                <?php     
                 }else{
                 ?>
                  <li class="page-item"><a class="page-link"
                    href="tampilaperdes.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $linkNext; ?>">Next</a>
                  </li>
                <?php
                  }
                }
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="POST" action="../CRUD/aksi_crud_perdes.php" enctype="multipart/form-data">
                      <div class="form-group">
                        <label class="control-label">Jenis Perdes</label>
                        <input type="text" name="apjp" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label class="control-label">No dan Tanggal Ditetapkan</label>
                        <input type="text" name="apntd" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label class="control-label">Tentang</label>
                      ...
                      <div class="form-group">
                        <label class="control-label">Uraian</label>
                        <input type="text" name="apu" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label class="control-label">Tanggal Kesepakatan Perdes</label>
                        <input type="date" name="aptkp" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label class="control-label">No dan Tanggal Dilaporkan</label>
                        <input type="text" name="apntdl" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label class="control-label">No dan Tanggal Diundangkan Lembaran Desa</label>
                        <input type="text" name="apntdld" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label class="control-label">No dan Tanggal Diundangkan Berita Desa</label>
                        <input type="text" name="apntdbd" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label class="control-label">Keterangan</label>
                        <input type="text" name="apk" class="form-control" required>
                      </div>
                      <div class="form-group">
