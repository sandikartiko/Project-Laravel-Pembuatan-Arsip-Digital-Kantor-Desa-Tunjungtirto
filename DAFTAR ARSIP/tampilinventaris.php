...
<body>
        ...
        <ul>
          ...
          <li class="dropdown"><a class="nav-link scrollto active" href="#hero"><span>DAFTAR ARSIP</span> <i
            ...
            <ul>
              ...
              <li><a class="nav-link scrollto active" href="tampilinventaris.php">Inventaris Barang</a></li>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container" style="height: 38vh;">
          <h2 class="animate__animated animate__fadeInDown" style="font-size: 35px;">Daftar Inventaris Barang </h2>
  ...
  <!-- awal buat tabel inventarisbarang-->
  <section id="services" class="services">
    <div class="container">
      ...
      <div class="row">
          <div class="col">
            <center>
            <h1><i class="nav-icon fas fa-envelope my-1 btn-sm-1"></i> Inventaris Barang</h1>
            </center>
          </div>
        </div>
        <br>
                ...
                <form class="form-inline">
                  <div class="form-group">
                    <select class="form-control" id="Kolom" name="Kolom" required="">
                      ...
                      <option value="Tanggal_Pembelian" <?php if ($kolom=="Tanggal_Pembelian") echo "selected";?>>Tanggal</option>
                    </select>
                    <br>
                  </div>
                  ...
                  <a href="tampilinventaris.php" class="btn btn-danger">Reset</a>
                </form>
              </div>
            </div>
          </div>
        ...
        <div class="col">
          ...
          ||
            <a href="../CETAK DATA/cetakiventaris.php" class="btn btn-success" target="_blank"><i class="bi bi-printer-fill"> PRINT </a></i>
        </div>
        <br>
        <div class="row table-responsive">
          <div class="col">
            <table class="table table-dark table-striped">
              ...
              <?php 
                 $SqlQuery= mysqli_query($kon, "SELECT * FROM inventarisbarang ORDER BY Tanggal_Pembelian ");
                 ...
                 if($kolomCari=="" && $kolomKataKunci==""){
                   $SqlQuery = mysqli_query($kon, "SELECT * FROM inventarisbarang ORDER BY Tanggal_Pembelian LIMIT ".$limitStart.",".$limit);
                 }else{
                   //kondisi jika parameter kolom pencarian diisi
                   $SqlQuery = mysqli_query($kon, "SELECT * FROM inventarisbarang  WHERE $kolomCari LIKE '%$kolomKataKunci%' LIMIT ".$limitStart.",".$limit);
                 }
                 $no = $limitStart + 1;
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form method="POST" action="../CRUD/aksi_crud_inventaris.php" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?= $data['id']?>">
                        <div class="form-group">
                          <label class="control-label">Nama Barang</label>
                          <input type="text" name="inbarang" value="<?=$data['Nama_Barang']?>" class="form-control"
                            required>
                        </div>
                        <div class="form-group">
                          <label class="control-label">Tanggal Pembelian</label>
                          <input type="date" name="intanggal" value="<?=$data['Tanggal_Pembelian']?>" class="form-control"
                            required>
                        </div>
                        <div class="form-group">
                          <label class="control-label">Kondisi Barang</label>
                          <input type="text" name="inkondisi" value="<?=$data['Kondisi_Barang']?>" class="form-control"
                            required>
                        </div>
                        <div class="form-group">
                          <label class="control-label">Sumber Dana</label>
                          <input type="text" name="insumber" value="<?=$data['Sumber_Dana']?>" class="form-control"
                            required>
                       </div>
                        <div class="form-group">
                          <label class="control-label">Keterangan</label>
                          <input type="text" name="inketerangan" value="<?=$data['Keterangan']?>" class="form-control"
                            required>
                        </div>
                        <div class="form-group">
                          <label class="control-label">Upload file</label>
                          <input type="file" name="infile" value="<?=$data['File_Document']?>" class="form-control"
                            >
                        </div>
              ...
              <div class="modal fade" id="modalHapus<?= $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form method="POST" action="../CRUD/aksi_crud_inventaris.php">
                        <input type="hidden" name="id" value="<?= $data['id']?>">
            ...
            <nav aria-label="Page navigation example">
              <ul class="pagination justify-content-center">
                <li class="page-item disabled">
                   ...
                   ?>
                    ...
                    <?php
                           ...
                           if($kolomCari=="" && $kolomKataKunci==""){
                     ?>
                          <li class="page-item"><a class="page-link" href="tampilinventaris.php?page=<?php echo $LinkPrev; ?>">Previous</a></li>

                    <?php     
                     }else{
                    ?>
                          <li><a href="tampilinventaris.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $LinkPrev;?>">Previous</a></li>
                    <?php
                     } 
                   }
                   ?>
                   <?php
                    //kondisi jika parameter pencarian kosong
                    if($kolomCari=="" && $kolomKataKunci==""){
                    $SqlQuery = mysqli_query($kon, "SELECT * FROM inventarisbarang");
                    }else{
                          //kondisi jika parameter kolom pencarian diisi
                           $SqlQuery = mysqli_query($kon, "SELECT * FROM inventarisbarang WHERE $kolomCari LIKE '%$kolomKataKunci%'");
                    }     
                    ...
                    if($kolomCari=="" && $kolomKataKunci==""){
                    ?>
                        <li class="page-item" <?php echo $linkActive; ?>><a class="page-link"href="tampilinventaris.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                   <?php
                    }else{
                    ?>
                <li class="page-item" <?php echo $linkActive; ?>><a class="page-link"
                    href="tampilinventaris.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
                <?php
                  }
               }
                ...
                if($kolomCari=="" && $kolomKataKunci==""){
                ?>
                    <li class="page-item"><a class="page-link" href="tampilinventaris.php?page=<?php echo $linkNext; ?>">Next</a>
                </li>
                <?php     
                 }else{
                 ?>
                  <li class="page-item"><a class="page-link"
                    href="tampilinventaris.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $linkNext; ?>">Next</a>
                  </li>
                <?php
                  }
                }
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="POST" action="../CRUD/aksi_crud_inventaris.php" enctype="multipart/form-data">
                      <div class="form-group">
                        <label class="control-label">Nama Barang</label>
                        <input type="text" name="inbarang" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label class="control-label">Tanggal Pembelian</label>
                        <input type="date" name="intanggal" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label class="control-label">Kondisi Barang</label>
                        <input type="text" name="inkondisi" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label class="control-label">Sumber Dana</label>
                        <input type="text" name="insumber" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label class="control-label">Keterangan</label>
                        <input type="text" name="inketerangan" class="form-control" required>
                      </div>
                      <div class="form-group">
